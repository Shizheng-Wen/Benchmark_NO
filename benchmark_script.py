...
def init_dataset(dataset_config):
    ...
    x_train = rescale(x_train, (-1, 1), phy_domain)
    x_val = rescale(x_val, (-1, 1), phy_domain)
    x_test = rescale(x_test, (-1, 1), phy_domain)
            ...
            "model_variants": [
                {
                    ...
                    "args.args.transformer.attn_config.hidden_size": 256,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config", type=str, 
                        default="config/model_config/transolver.json", 
